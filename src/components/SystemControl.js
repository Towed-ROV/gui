import { Button, Heading, HStack, VStack, Text, Slider, Switch, Spacer, Box, useColorModeValue, SliderTrack, SliderFilledTrack, SliderThumb } from "@chakra-ui/react";
    ...
    return (
        <VStack p={6} justifyContent="space-evenly">
              ...
              <HStack>
                ...
                <Text fontSize="xl" color={textColor}>Logging</Text>
                <Spacer />
                <Switch
                  name="Status"
                  ...
                  <Switch onChange={(e) => toggleAutoMode()} size="lg" colorScheme="green"/>
                  <Text fontSize="xl" color={textColor}>
                    Depth or Seafloor
                  </Text>
